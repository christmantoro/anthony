...
export const BookCard = ({ book }: { book: Book }) => {
    return (
      <div className="flex flex-col md:flex-row items-center bg-gray-900 rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl">
        ...
        <div className="md:w-2/3 p-6">
          ...
          <p className="text-gray-300 line-clamp-4">{book.description}</p>
        </div>
      </div>
    );
  };

  export default function InspiringBooksSection() {
    const books: Book[] = [
      {
